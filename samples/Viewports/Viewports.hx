...
class Viewports extends Template {
	...
	override function init() {
		...
		space.listeners.add(new InteractionListener(CbEvent.BEGIN, InteractionType.SENSOR, viewportType, viewableType, enterViewportHandler));
		space.listeners.add(new InteractionListener(CbEvent.END, InteractionType.SENSOR, viewportType, viewableType, exitViewportHandler));
